...
def test_ei_calculate_turnout_adjusted_samples(two_r_by_c_ei_runs):
    ...
    non_adjusted_samples = np.transpose(
        example_r_by_c_ei.sim_trace["posterior"]["b"]
...
def test_computation_of_districtwide_samples(two_r_by_c_ei_runs):
    """Testing calculations of RowByColumnEI.sampled_voting_prefs"""
    ei_ex = two_r_by_c_ei_runs[0]

    def calculate_districtwide_samples_basic(
        samples, demographic_group_fractions, precinct_pops
    ):
...
def test_candidate_of_choice_polarization_report(two_r_by_c_ei_runs):
    example_r_by_c_ei = two_r_by_c_ei_runs[0]
...
def test_polarization_report(two_r_by_c_ei_runs):
    example_r_by_c_ei = two_r_by_c_ei_runs[0]
...
def test_ei_r_by_c_boxplots(two_r_by_c_ei_runs):
    example_r_by_c_ei = two_r_by_c_ei_runs[0]
...
def test_ei_r_by_c_kdes(two_r_by_c_ei_runs):
    example_r_by_c_ei = two_r_by_c_ei_runs[0]
...
def test_ei_r_by_c_intervals_by_precinct(two_r_by_c_ei_runs):
    example_r_by_c_ei = two_r_by_c_ei_runs[0]
    assert (
...
def test_plot_polarization_kde(two_r_by_c_ei_runs):
    example_r_by_c_ei = two_r_by_c_ei_runs[0]
    groups = ["ind", "e_asian"]
    candidate = "Kolstad"
...
def test_plot_margin_kde(two_r_by_c_ei_runs):
    example_r_by_c_ei = two_r_by_c_ei_runs[0]
